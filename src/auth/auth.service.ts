...
export class AuthService {
  constructor(
    private readonly userQueryRepo: UserQueryRepo, // private readonly authRepository: AuthRepository, // private readonly usersService: UsersService, // private readonly jwtService: JwtService, // private readonly emailService: Email, // private readonly passwordRecoveryRepository: PasswordRecoveryRepository,
  ) {}
  ...
  //     convertJwtPayloadSecondsToIsoDate(iat),
  //     id,
  //     deviceId,
  //   );
  //   if (!foundedSession) {
  ...
  //   const accessToken = jwt.sign({ id, login }, process.env.JWT_ACCESS_SECRET, {
  //     expiresIn: EXPIRES_ACCESS_TIME,
  //   });
  //   const refreshToken = jwt.sign(
  //     { id, deviceId },
